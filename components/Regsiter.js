  ...
  return (
    <div>
      <Link href="/register/medic">
        <div className=" bg-c5 flex flex-col justify-center text-center h-28">
          Medic
        </div>
      </Link>
      <Link href="/register/pacient">
        <div className=" bg-c2 flex flex-col justify-center text-center h-28">
          Pacient
        </div>
      </Link>
