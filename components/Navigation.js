...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 w-full left-0 bg-inherit flex items-center justify-between px-10 py-5 border-b-2 border-solid border-c2 bg-white text-lg z-20">
